/*
S(1000000000000) = 1511432981192
execution time : 0.901 s

S(100000000000000) = 405717097390344
execution time : 10.783 s

S(10000000000000000) = 42416147601971176
execution time : 158.036 s

S(1000000000000000000) = 3878049896917255512
execution time : 2645.806 s

S(1000000000000000) = 4985898162020520
execution time : 38.922 s
*/
...
bool calc_pminmax(int p, ll n, ll sn, int& pmin, int& pmax)
{
    ...
    double v1 = 2.0*n/sn;
    double v2 = 128.0/sn;
    double rmin = v1 - v2/(p+1);
    double rmax = v1 - v2/ndivn;
