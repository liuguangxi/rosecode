...
printf "Profit: %d\n", 20 * 10000 - 1000 - 30 * (x12 + x13 + x14 + x23 + x24 + x34) - 50 * (x123 + x124 + x134 + x234) - 100 * x1234 > "rc358_min.txt";
printf "x0: %d\n", x0 >> "rc358_min.txt";
printf "x1: %d, x2: %d, x3: %d, x4: %d\n", x1, x2, x3, x4 >> "rc358_min.txt";
printf "x12: %d, x13: %d, x14: %d, x23: %d, x24: %d, x34: %d\n", x12, x13, x14, x23, x24, x34 >> "rc358_min.txt";
printf "x123: %d, x124: %d, x134: %d, x234: %d\n", x123, x124, x134, x234 >> "rc358_min.txt";
printf "x1234: %d\n", x1234 >> "rc358_min.txt";
